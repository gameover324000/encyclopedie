...
Lit chaque fichier HTML dans I_Plante_page/, extrait le nom et la famille,
...
DOSSIER_HTML  = "./J_Plante_page"   # ← Chemin vers ton dossier de pages HTML
LOG_FILE      = "generation_log_descriptions_J.json"
